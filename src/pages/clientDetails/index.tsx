        ...
        <div className="flex">
            ...
            <div className="container mx-auto px-6 py-5">
                <div className="mx-auto">
                    <h1 className="text-2xl font-bold text-gray-900">Dados do cliente <span className="text-indigo-600">Meridith</span></h1>
                </div>
                                            ...
                                            <div className="mt-2 sm:mt-0 sm:col-span-4">
                                                <div className="grid grid-cols-1 sm:grid-cols-2 col-span-2 gap-x-4 gap-y-5">
                                                    <div className="col-span-1">
                                                        ...
                                                        <input type="text" name="" id="" value="Meridith" placeholder="Nome do cliente" className="mt-2 border block w-full px-4 py-3 placeholder-gray-500 border-gray-300 rounded-lg focus:ring-indigo-600 focus-visible:border-indigo-600 focus:border-indigo-600 sm:text-sm caret-indigo-600" required />
                                                    </div>

                                                    <div className="col-span-1">
                                                        <label htmlFor="" className="block text-sm font-medium text-gray-600"> Veículo </label>
                                                        <input type="text" name="" id="" placeholder="" value="Site Imobiliária" className="mt-2 border block w-full px-4 py-3 placeholder-gray-500 border-gray-300 rounded-lg focus:ring-indigo-600 focus-visible:border-indigo-600 focus:border-indigo-600 sm:text-sm caret-indigo-600" required />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
